...
从 Binance API 或 cache 获取约 400 天 BTC 日线收盘价（Oldest first），叠加 SMA50/SMA200，背景根据 Mayer Multiple 着色（<1.0 浅绿色低估、1.0-2.4 灰色中性、>2.4 浅红色高估）。x 轴用月格式 `YYYY-MM`，每 30 天一个刻度，旋转 45°。

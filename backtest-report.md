...
| 1 | -M- 仅动量（接飞刀 ⚠️） | 131 | -33.4% | 11% | -60.4% |
...
2. **-M-（-33.4%, 11%胜率）是最大陷阱** — 价格在 200 日均线下但估值不便宜 = 典型接飞刀。散户最易犯的错
3. **--P（-22.7%, 14%胜率）同样是陷阱** — 恐慌本身不是买入信号，必须验证估值维度

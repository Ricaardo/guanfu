...
数据集存于 `~/.guanfu/prices/` JSON 日频存档。来源:CoinMetrics / Binance / Yahoo / FRED / DefiLlama / CFTC / Shiller / Stooq / Deribit / CoinMarketCap / SoSoValue / CoinGecko / mempool.space / alternative.me。
...
| 期权/情绪 | deribit_dvol / deribit_skew_25d_pct / stooq_putcall | Deribit / Stooq |
...
| Deribit | BTC DVOL + 25-delta skew | ✅ |
| Stooq | CBOE total put/call ratio | 需 API key |

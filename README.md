...
统一 `guanfu refresh` 刷新框架(26 个 Source 实现):首次全量,后续增量(`last_date` ≤ 24h 跳过;月频 CAPE 28d TTL)。非 refresh 框架的 BTC 链上源独立拉取（CoinGecko / mempool / SoSoValue / alternative.me / Binance / CoinMetrics community）。
